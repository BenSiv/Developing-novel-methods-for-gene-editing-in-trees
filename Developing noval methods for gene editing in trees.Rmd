...
Signature of student: Ben Sivan \includegraphics[height=0.5cm]{bensig.jpg} \hfill Date: 31/07/2022 \break \newline Signature of supervisor: Prof. Martin Goldway \includegraphics[height=0.5cm]{martinsig.jpg} \hfill Date: 31/07/2022 \break \newline Signature of supervisor: Dr. Amir Raz \includegraphics[height=0.5cm]{amirsig.jpg} \hfill Date: 31/07/2022 \break \newline Signature of chairperson for graduate studies:_______________Date:____/____/_______

\begin{titlepage}

   \begin{center}

      \includegraphics[height=2cm]{TelHaiLogo.jpg}
      \hfill
      \includegraphics[height=2cm]{MigalLogo.png}
        
      \vspace{0.5cm}

      \textbf{\huge THE FACULTY OF SCIENCES}
      \vspace{0.1cm}
      \textbf{\huge MASTER IN BIOTECHNOLOGY}
...
As a result of the development of the molecular genetic field, many genetic modification technologies were innovated, some of them applicable or specific to plants. Those methods are more direct in their approach to manipulating DNA for an expected outcome and can be included under the broad term genomic engineering. Genome engineering is commonly referred to as the integration of foreign DNA into the genome. Whereas the term genome editing in the regulatory context, refers to the act of changing the expression patterns in the cell, either by deactivating a gene with the introduction of a deliberate mutation, or by changing the expression patterns of regulatory elements. This work focuses on technics to achieve genome editing, although in the process, there are stages of integration of CRISPR/Cas9 for the purpose of achieving gene mutation.
The method is divided into two parts, exogenous DNA delivery methods and site-specific endonucleas mutating. 
