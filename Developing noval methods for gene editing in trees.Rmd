...
```{r qPCR_normalizers, echo=FALSE, out.width = "100%", fig.align="center", echo=FALSE, fig.show="hold" ,fig.pos= "H", fig.cap="Expression of internal normalizers gene analyzed by RT-qPCR. CV referse to the coefficient of variation and it represent a score for the amount in which the normalizer expressed consistently between the different tissues. As the CV get smaller, the expression is more uniform."}
par(mfrow = c(1,3))

qPCR_actin_only <- read.csv("Tables/Actin_only.csv")
Actin_CV = round(sd(qPCR_actin_only$Avg_Cq)/mean(qPCR_actin_only$Avg_Cq), digits = 2)
Actin_only_plot = barplot(qPCR_actin_only$Avg, names = qPCR_actin_only$Tissue, ylim = c(0, 1), main = paste("Actin-7 \n CV = ", Actin_CV), las = 2)

qPCR_PP2A4_only <- read.csv("Tables/PP2A4_only.csv")
PP2A4_CV = round(sd(qPCR_PP2A4_only$Avg_Cq)/mean(qPCR_PP2A4_only$Avg_Cq), digits = 2)
PP2A4_only_plot = barplot(qPCR_PP2A4_only$Avg, names = qPCR_PP2A4_only$Tissue, ylim = c(0, 1), main = paste("PP2A-4 \n CV = ", PP2A4_CV), las = 2)

qPCR_E3_only <- read.csv("Tables/E3_only.csv")
E3_CV = round(sd(qPCR_E3_only$Avg_Cq)/mean(qPCR_E3_only$Avg_Cq), digits = 2)
E3_only_plot = barplot(qPCR_E3_only$Avg, names = qPCR_E3_only$Tissue, ylim = c(0, 1), main = paste("E3 Ubiquitin ligase \n CV = ", E3_CV), las = 2)
