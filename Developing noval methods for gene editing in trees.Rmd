...
* [Gibson Assembly Cloning](https://www.addgene.org/protocols/gibson-assembly/) [@Gibson2009]
* [Golden-Gate cloning](https://blog.addgene.org/plasmids-101-golden-gate-cloning)[@Cermak2017]
...
* CTAB protocol for the isolating of DNA from plant tissues[@Porebski1997]
...
# Results
In this work we are attempting to implement a novel gene editing method in-planta on trees. We worked on two cultivars, PopAT from vegetative reproduction in tissue culture and apples from seeds. In this research we used PopAT plants as the best case scenario for gene editing in trees. With PopAT we could control and mitigate as much of the variability in our experiment, because there is no genetic diversity in the plants and as a model organism they are known to be susceptible to agroinfiltration. With apples is was a whole different story, the plants were grown from seeds and because the plants are known to be selfincompatible, the seedlings are much more diverse in their genetic makeup. Although our research is based on some success of others, still there is no consensus about the best practice to approach in-planta transformation. On the one hand, we try new plants and new DRs, therefor it would be logical to go way back to expression in tissue culture for the assessment of those genes. On the other hand, we dont want to strey so far from our final goal of in-planta transformation and because the complexity of the biological system, it is well understood that we can not deduce from tissue culture results to an in-planta experiment in a straight forward manner. Hence, our experiment scheme starts right away with in-planta experiment, but from the basics of that stage without tacking much for grunted. At first, we assess the best approach to facilitate the infiltration of the agrobacterium by different mechanical interventions. Later, we assess the influence of different combination of DRs on the plant development. Finaly, we scale up the best findings from the last two for statistical analysis purposes. In parallel to all that, we try to inhance our over all knowledge on the natural expression of genes in the different tissues and especially in the shoot-tip by analysing tissue specific transcriptome from PopAT.

## Implementing De-novo maristem induction and transformation.

### Construction of plasmids containing DRs, Cas9 and sgRNAs
This work is exploratory in nature, as a results a variety of plasmids was required to insure a wide range of DR combinations on both cultivars with different a reporter gene. As consequence, over 40 plasmids were planed and as mush as 21 final plasmids were used. The construction of the plasmid were planed with the golden gate assembly protocol in mind. This assembly method is based on the compatibility of a backbone and 4 modules. Each module can either include a functional insert or not at all. The combination of the different building blocks is what gives us the diverse array of plasmids. Some of the building blocks were available to purchase ready made for use, but some was needed to be constructed in house. 
...
[Analysis code link.](https://htmlpreview.github.io/?https://rsaw.githubusercontent.com/BenSiv/PopAT-expression-analysis/main/PopAT_Expression.html)
