...
### Construction of plasmids containing DRs, Cas9 and sgRNAs
This work is exploratory in nature, as a result a variety of plasmids was required to insure a wide range of DR combinations on both cultivars with different reporter genes. As a consequence, over 40 plasmids were planned and as much as 21 final plasmids were used (Table \ref{tab:AllConstracts}). The construction of the plasmid was planned with the golden gate assembly protocol in mind. This assembly method is based on the compatibility of a backbone and 4 modules. Each module can either include a functional insert or not at all. The combination of the different building blocks is what gives us the diverse array of plasmids. Some of the building blocks were available to purchase ready made for use, but some needed to be constructed in house. 
